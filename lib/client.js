...
function createApiClient(options) {
  ...
  return {
    ...
    sales: createSales({ baseURL: baseURL, timeout: timeout, overrideFn: baseURLOverride.sales }),
    operations: createOperations({ baseURL: baseURL, timeout: timeout, overrideFn: baseURLOverride.operations })
  };
}
...
function createInventory(_ref3) {
  ...
  return {
    ...
    promos: require("./endpoints/inventory/promos")({ client: client }),
    fees: require("./endpoints/inventory/fees")({ client: client }),
    items: require("./endpoints/inventory/items")({ client: client }),
    trips: require("./endpoints/inventory/trips")({ client: client }),
    filteredTrips: require("./endpoints/inventory/filtered-trips")({ client: client }),
    ssrs: require("./endpoints/inventory/ssrs")({ client: client }),
    __test: {
      client: client
    }
  };
...
function createAccounts(_ref4) {
  ...
  return {
    ...
    shifts: require("./endpoints/accounts/shifts")({ client: client }),
    customers: require("./endpoints/accounts/customers")({ client: client }),
    __test: {
      client: client
    }
  };
...
function createSales(_ref5) {
  ...
  return {
    paymentProviders: require("./endpoints/sales/payment-providers")({ client: client }),
    cart: require("./endpoints/sales/cart")({ client: client }),
    giftCertificates: require("./endpoints/sales/gift-certificates")({ client: client }),
    customFields: require("./endpoints/sales/custom-fields")({ client: client }),
    order: require("./endpoints/sales/order")({ client: client }),
    voucher: require("./endpoints/sales/voucher")({ client: client }),
    __test: {
      client: client
    }
  };
...
function createOperations(_ref6) {
  ...
  return {
    parcel: require("./endpoints/operations/parcels")({ client: client }),
    appliedInsurance: require("./endpoints/operations/applied_insurance")({ client: client }),
    transaction: require("./endpoints/operations/transaction")({ client: client }),
    manifest: require("./endpoints/operations/manifest")({ client: client }),
    redemption: require("./endpoints/operations/redemption")({ client: client }),
    __test: {
      client: client
    }
  };

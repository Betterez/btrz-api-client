...
function createApiClient(options) {
  ...
  return {
    ...
    liveSeatmaps: createLiveSeatmaps({ baseURL: baseURL, timeout: timeout, overrideFn: baseURLOverride.liveSeatmaps, internalAuthTokenProvider: internalAuthTokenProvider })
  };
}
...
function createLiveSeatmaps(_ref12) {
  ...
  return {
    accessTicket: require("./endpoints/liveseatmaps/access-ticket")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
    __test: {
      client: client
    }
  };

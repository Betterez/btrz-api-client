...
function createAccounts(_ref4) {
  ...
  return {
    ...
    emailTemplates: require("./endpoints/accounts/email-templates.js")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
    ...
    operationSettings: require("./endpoints/accounts/operation-settings.js")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
...
function createReports(_ref7) {
  ...
  return {
    ...
    reportEmail: require("./endpoints/reports/email.js")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
    tripManifests: require("./endpoints/reports/trip-manifests.js")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
    __test: {
      client: client
    }
...
function createInvoices(_ref14) {
  ...
  return {
    ...
    invoices: require("./endpoints/invoices/invoices.js")({ client: client, internalAuthTokenProvider: internalAuthTokenProvider }),
    __test: {
      client: client
    }
  };

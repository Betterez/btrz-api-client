...
function clientFactory(opts) {
  ...
  const overrideFn = opts.overrideFn;
...
function createInventory(_ref) {
  ...
  const overrideFn = _ref.overrideFn;
  const internalAuthTokenProvider = _ref.internalAuthTokenProvider;
  const agents = _ref.agents;
...
function createTrips(_ref2) {
  const baseURL = _ref2.baseURL;
  const headers = _ref2.headers;
  const timeout = _ref2.timeout;
  const overrideFn = _ref2.overrideFn;
  const internalAuthTokenProvider = _ref2.internalAuthTokenProvider;
  const agents = _ref2.agents;
...
function createColtrane(_ref3) {
  const baseURL = _ref3.baseURL;
  const headers = _ref3.headers;
  const timeout = _ref3.timeout;
  const overrideFn = _ref3.overrideFn;
  const internalAuthTokenProvider = _ref3.internalAuthTokenProvider;
  const agents = _ref3.agents;
...
function createAccounts(_ref4) {
  const baseURL = _ref4.baseURL;
  const headers = _ref4.headers;
  const timeout = _ref4.timeout;
  const overrideFn = _ref4.overrideFn;
  const internalAuthTokenProvider = _ref4.internalAuthTokenProvider;
  const agents = _ref4.agents;
...
function createSales(_ref5) {
  const baseURL = _ref5.baseURL;
  const headers = _ref5.headers;
  const timeout = _ref5.timeout;
  const overrideFn = _ref5.overrideFn;
  const internalAuthTokenProvider = _ref5.internalAuthTokenProvider;
  const agents = _ref5.agents;
...
function createOperations(_ref6) {
  const baseURL = _ref6.baseURL;
  const headers = _ref6.headers;
  const timeout = _ref6.timeout;
  const overrideFn = _ref6.overrideFn;
  const internalAuthTokenProvider = _ref6.internalAuthTokenProvider;
  const agents = _ref6.agents;
...
function createReports(_ref7) {
  const baseURL = _ref7.baseURL;
  const headers = _ref7.headers;
  const timeout = _ref7.timeout;
  const overrideFn = _ref7.overrideFn;
  const internalAuthTokenProvider = _ref7.internalAuthTokenProvider;
  const agents = _ref7.agents;
  ...
  return {
    ...
    tripManifests: require("./endpoints/reports/trip-manifests.js")({client, internalAuthTokenProvider}),
    __test: {
      client
    }
...
function createNotifications(_ref8) {
  const baseURL = _ref8.baseURL;
  const headers = _ref8.headers;
  const timeout = _ref8.timeout;
  const overrideFn = _ref8.overrideFn;
  const internalAuthTokenProvider = _ref8.internalAuthTokenProvider;
  const agents = _ref8.agents;
...
function createUploads(_ref9) {
  const baseURL = _ref9.baseURL;
  const headers = _ref9.headers;
  const timeout = _ref9.timeout;
  const overrideFn = _ref9.overrideFn;
  const internalAuthTokenProvider = _ref9.internalAuthTokenProvider;
  const agents = _ref9.agents;
...
function createLoyalty(_ref10) {
  const baseURL = _ref10.baseURL;
  const headers = _ref10.headers;
  const timeout = _ref10.timeout;
  const overrideFn = _ref10.overrideFn;
  const internalAuthTokenProvider = _ref10.internalAuthTokenProvider;
  const agents = _ref10.agents;
...
function createWebhooks(_ref11) {
  const baseURL = _ref11.baseURL;
  const headers = _ref11.headers;
  const timeout = _ref11.timeout;
  const overrideFn = _ref11.overrideFn;
  const internalAuthTokenProvider = _ref11.internalAuthTokenProvider;
  const agents = _ref11.agents;
...
function createSeatmaps(_ref12) {
  const baseURL = _ref12.baseURL;
  const headers = _ref12.headers;
  const timeout = _ref12.timeout;
  const overrideFn = _ref12.overrideFn;
  const internalAuthTokenProvider = _ref12.internalAuthTokenProvider;
  const agents = _ref12.agents;
...
function createBtrzPay(_ref13) {
  ...
  const baseURL = _ref13.baseURL;
  const headers = _ref13.headers;
  const timeout = _ref13.timeout;
  const overrideFn = _ref13.overrideFn;
  const internalAuthTokenProvider = _ref13.internalAuthTokenProvider;
  const agents = _ref13.agents;
  ...
  }, _defineProperty(_ref14, "adyen", require("./endpoints/btrzpay/adyen.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "cardpointeTerminals", require("./endpoints/btrzpay/cardpointe.js").cardpointeTerminalsFactory({client, internalAuthTokenProvider})), _defineProperty(_ref14, "paymentMethods", require("./endpoints/btrzpay/payment-methods.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "referenceNumbers", require("./endpoints/btrzpay/reference-numbers.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "payments", require("./endpoints/btrzpay/payments.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "referencedPayments", require("./endpoints/btrzpay/referenced-payments.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "customers", require("./endpoints/btrzpay/customers.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "customerCards", require("./endpoints/btrzpay/customerCards.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "squareTerminals", require("./endpoints/btrzpay/square.js").squareTerminalsFactory({client, internalAuthTokenProvider})), _defineProperty(_ref14, "squareWebhooks", require("./endpoints/btrzpay/square.js").squareWebhooksFactory({client, internalAuthTokenProvider})), _defineProperty(_ref14, "oxxo", require("./endpoints/btrzpay/oxxo.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "datalogic", require("./endpoints/btrzpay/datalogic.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "prismaTerminals", require("./endpoints/btrzpay/prismaTerminals.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "terminalPayments", require("./endpoints/btrzpay/terminalPayments.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "stripeTerminals", require("./endpoints/btrzpay/stripe-terminals.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "stripe3ds", require("./endpoints/btrzpay/stripe3ds.js")({client, internalAuthTokenProvider})), _defineProperty(_ref14, "__test", {
    client
  }), _ref14;
}
...
function createInvoices(_ref15) {
  const baseURL = _ref15.baseURL;
  const headers = _ref15.headers;
  const timeout = _ref15.timeout;
  const overrideFn = _ref15.overrideFn;
  const internalAuthTokenProvider = _ref15.internalAuthTokenProvider;
  const agents = _ref15.agents;
...
function createGPS(_ref16) {
  const baseURL = _ref16.baseURL;
  const headers = _ref16.headers;
  const timeout = _ref16.timeout;
  const overrideFn = _ref16.overrideFn;
  const internalAuthTokenProvider = _ref16.internalAuthTokenProvider;
  const agents = _ref16.agents;
...
function createRatality(_ref17) {
  const baseURL = _ref17.baseURL;
  const headers = _ref17.headers;
  const timeout = _ref17.timeout;
  const overrideFn = _ref17.overrideFn;
  const agents = _ref17.agents;
...
function createApiClient(options) {
  const _ref18 = options || productionOptions;
  const baseURL = _ref18.baseURL;
  const _ref18$baseURLOverrid = _ref18.baseURLOverride;
  const baseURLOverride = _ref18$baseURLOverrid === undefined ? {} : _ref18$baseURLOverrid;
  const headers = _ref18.headers;
  const _ref18$timeout = _ref18.timeout;
  const timeout = _ref18$timeout === undefined ? 0 : _ref18$timeout;
  const internalAuthTokenProvider = _ref18.internalAuthTokenProvider;
  const agents = _ref18.agents;

  return {
    constants: require("./constants.js"),
    _cleanClient: clientFactory({baseURL, headers, timeout, agents}),
    inventory: _extends({}, createInventory({baseURL, headers, timeout, overrideFn: baseURLOverride.inventory, internalAuthTokenProvider, agents}), createTrips({baseURL, headers, timeout, overrideFn: baseURLOverride.trips, internalAuthTokenProvider, agents})),

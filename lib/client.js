...
function createApiClient(options) {
  ...
  return {
    ...
    liveSeatmaps: createSeatmaps({ baseURL: baseURL, timeout: timeout, overrideFn: baseURLOverride.liveSeatmaps, internalAuthTokenProvider: internalAuthTokenProvider })
  };
}

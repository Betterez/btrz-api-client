...
function manifestFactory(_ref) {
  ...
  function getOne(_ref3) {
    var token = _ref3.token,
        jwtToken = _ref3.jwtToken,
        _ref3$query = _ref3.query,
        query = _ref3$query === undefined ? {} : _ref3$query;

    return get({ token: token, jwtToken: jwtToken, query: Object.assign({ returnSingleElement: true }, query) });
  }
  ...
  function getById(_ref4) {
    ...
    return getOne({ token: token, jwtToken: jwtToken, query: { manifestId: manifestId } });
  }

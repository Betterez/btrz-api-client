...
function marketplaceModifierFactory(_ref) {
   ...
   */
  function get(_ref3) {
    const marketplaceModifierId = _ref3.marketplaceModifierId;
  ...
  function create(_ref4) {
    ...
    const marketplaceModifier = _ref4.marketplaceModifier;
  ...
  function remove(_ref5) {
    ...
    const marketplaceModifierId = _ref5.marketplaceModifierId;
  ...
  function update(_ref6) {
    ...
    const marketplaceModifierId = _ref6.marketplaceModifierId;
    const marketplaceModifier = _ref6.marketplaceModifier;

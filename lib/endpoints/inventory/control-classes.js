...
function controlClassesFactory(_ref) {
   ...
   */
  function get(_ref3) {
    const controlClassId = _ref3.controlClassId;
  ...
  function create(_ref4) {
    ...
    const controlClass = _ref4.controlClass;
  ...
  function remove(_ref5) {
    ...
    const controlClassId = _ref5.controlClassId;
  ...
  function update(_ref6) {
    ...
    const controlClassId = _ref6.controlClassId;
    const controlClass = _ref6.controlClass;
  ...
  const schedules = {
    post: function post(_ref7) {
      ...
      const controlClassId = _ref7.controlClassId;

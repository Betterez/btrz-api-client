...
function operationMessagesFactory(_ref) {
  ...
  function create(_ref3) {
    ...
    const opMsgData = _ref3.opMsgData;
  ...
  function update(_ref4) {
    ...
    const operationMessageId = _ref4.operationMessageId;
    const opMsgData = _ref4.opMsgData;
  ...
  function get(_ref5) {
    ...
    const operationMessageId = _ref5.operationMessageId;
  ...
  function remove(_ref6) {
    ...
    const operationMessageId = _ref6.operationMessageId;
  ...
  function getByStation(_ref7) {
    ...
    const opMsgData = _ref7.opMsgData;

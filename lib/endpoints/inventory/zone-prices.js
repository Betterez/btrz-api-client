...
function zonePriceFactory(_ref) {
   ...
   */
  function get(_ref3) {
    const zonePriceId = _ref3.zonePriceId;
  ...
  function create(_ref4) {
    ...
    const zonePrice = _ref4.zonePrice;
  ...
  function remove(_ref5) {
    ...
    const zonePriceId = _ref5.zonePriceId;
  ...
  function update(_ref6) {
    ...
    const zonePriceId = _ref6.zonePriceId;
    const zonePrice = _ref6.zonePrice;

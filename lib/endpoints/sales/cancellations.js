...
function cancellationEndpointsFactory(_ref) {
  ...
  function createCancelSet(_ref2) {
    ...
    const cancelData = _ref2.cancelData;
  ...
  function createRefund(_ref3) {
    ...
    const cancelSet = _ref3.cancelSet;
  ...
  function updateCompletePayment(_ref4) {
    ...
    const pendingTransactionId = _ref4.pendingTransactionId;
    const paymentResult = _ref4.paymentResult;

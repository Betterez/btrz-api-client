...
function shiftsFactory(_ref) {
  ...
  function create(_ref4) {
    ...
    const shiftData = _ref4.shiftData;
  ...
  function update(_ref5) {
    ...
    const shiftId = _ref5.shiftId;
    const operations = _ref5.operations;
  ...
  const locationClosureComments = {
    ...
    create: function create(_ref6) {
      ...
      const locationClosureId = _ref6.locationClosureId;
      const locationClosureComment = _ref6.locationClosureComment;
  ...
  const locationClosureStatus = {
    ...
    update: function update(_ref7) {
      ...
      const locationClosureId = _ref7.locationClosureId;
      const locationClosureStatusChange = _ref7.locationClosureStatusChange;
  ...
  const locationClosures = {
    ...
    create: function create(_ref8) {
      ...
      const locationClosure = _ref8.locationClosure;
    ...
    get: function get(_ref10) {
      ...
      const locationClosureId = _ref10.locationClosureId;
  ...
  const deposits = {
    ...
    create: function create(_ref24) {
      ...
      const shiftId = _ref24.shiftId;
      const deposit = _ref24.deposit;
  ...
  const manualTickets = {
    ...
    create: function create(_ref26) {
      ...
      const shiftId = _ref26.shiftId;
      const manualTicket = _ref26.manualTicket;
  ...
  const startingBalances = {
    ...
    create: function create(_ref27) {
      ...
      const shiftId = _ref27.shiftId;
      const startingBalance = _ref27.startingBalance;
  ...
  const purchaseLimitPayments = {
    ...
    get: function get(_ref28) {
      ...
      const locationId = _ref28.locationId;
      const query = _ref28.query;
  ...
  const salesSummary = {
    ...
    get: function get(_ref29) {
      ...
      const shiftId = _ref29.shiftId;
      const query = _ref29.query;
  ...
  const requiresAgencyShiftClosure = {
     ...
     * @returns {Promise<import("axios").AxiosResponse>}
     */
    put: function put(_ref31) {
      const token = _ref31.token;
      const jwtToken = _ref31.jwtToken;
      const shiftId = _ref31.shiftId;
      const headers = _ref31.headers;
      const shiftData = _ref31.shiftData;

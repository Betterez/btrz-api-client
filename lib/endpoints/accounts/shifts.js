...
function shiftsFactory(_ref) {
  ...
  var manualTickets = {
    ...
    create: function create(_ref26) {
      var jwtToken = _ref26.jwtToken,
          ...
          manualTicket = _ref26.manualTicket,
  ...
  var startingBalances = {
    ...
    create: function create(_ref27) {
      var jwtToken = _ref27.jwtToken,
          token = _ref27.token,
          shiftId = _ref27.shiftId,
          startingBalance = _ref27.startingBalance,
  ...
  var requiresAgencyShiftClosure = {
    ...
    put: function put(_ref31) {
      var token = _ref31.token,
          jwtToken = _ref31.jwtToken,
          shiftId = _ref31.shiftId,
          headers = _ref31.headers,
          shiftData = _ref31.shiftData;

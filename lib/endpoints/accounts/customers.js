...
function customersFactory(_ref) {
  ...
  function signIn(_ref5) {
    ...
    const password = _ref5.password;
    const apiKey = _ref5.apiKey;
  ...
  function signInCas(_ref6) {
    const service = _ref6.service;
    const ticket = _ref6.ticket;
  ...
  function update(_ref7) {
    const customerId = _ref7.customerId;
  ...
  function merge(_ref8) {
    const destinationCustomerId = _ref8.destinationCustomerId;
    const sourceCustomerIds = _ref8.sourceCustomerIds;
